...
**`raw-extract-amateur-callsigns-11-nov-2025.csv`** (csv, utf8)
...
| `status` | `Status` | verbatim |
| `licence_class` | `Product__c` | verbatim |
| `last_modified_date` | `Licence_Version.LastModifiedDate` | date |
| `original_start_date` | `Licence_Version.Original_start_date__c` | date |

Required-present but not carried: `Type__c`, `unknown-1`, `unknown-2`, `unknown-3`, `unknown-4`, `unknown-5`.
