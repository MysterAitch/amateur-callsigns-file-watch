...
| **Test conventions** — kind tags (`unit` / `ui` / `data-validity`), the non-vacuity guard, round-trips where a change spans layers, and naming | [`../../CONTRIBUTING.md`](../../CONTRIBUTING.md) § Test conventions | [`../../src/testing/test-taxonomy.test.ts`](../../src/testing/test-taxonomy.test.ts) enforces the tag; [`../../src/testing/non-vacuity.ts`](../../src/testing/non-vacuity.ts) enforces the guard by refusing an empty collection itself |
