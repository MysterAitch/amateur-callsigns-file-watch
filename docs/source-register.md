...
| Ofcom full list, ~2021 (asset 210648, 146,472 rows) | ~2021 | pending-ingest | the third 2021 harvest asset; the held copy is `#REF!`-corrupted (formula errors in place of values), so not ingested — tracked in #335 pending a clean re-fetch |
...
| Ofcom open-data "amateur-callsigns-11-nov-2025.csv" | 2025-11-11 | ingested | web-archive-recovered (Internet Archive Wayback capture 2025-12-02) open-data-page CSV, NOT an FOI disclosure — placed in the recovered lane because the date-keyed open-data lane's newest-only diff chain rejects back-dated inserts; ingested as `archive/foi/ofcom-2025-11-11--callsigns--all-callsigns` (159,895 records, variant `ofcom-2025-11-11-register`; day-first CSV carried through a shape-only header extract — five empty trailing columns filled `unknown-1..5` — so it reconstructs losslessly). Single Wayback witness |
| Ofcom open-data "amateur-callsign-list.xlsx" | 2026-01-14 | ingested | web-archive-recovered (UK Government Web Archive capture 2026-02-04) open-data-page workbook; recovered lane; ingested as `archive/foi/ofcom-2026-01-14--callsign-list--all-callsigns` (146,417 records, variant `ofcom-2026-01-14-register`; ISO dates typed at source). ~13,478 fewer records than the 11 Nov 2025 snapshot — a net removal (allocated −9,561, reserved −3,950), consistent with the single-callsign-per-licensee change. Single UKGWA witness |
