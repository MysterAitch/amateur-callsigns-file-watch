...
| WDTK October 2016 repeat of the available-list ask (reportedly answered "not held" - the earliest known not-held answer in the series; cited in the wdtk-309076 correspondence) | 2016-10 | pending-fetch | locate the WDTK thread; would date the start of the not-held era between 2016-06 (285990 list served) and 2016-10 |
