...
describe('v1 self-containment', { tags: ['unit'] }, () => {
  ...
  it('V1Surface_ShipsTheLaunchedPages_AndTheirChrome', () => {
    ...
    for (const page of ['index.html', 'callsign.html', 'on-this-day.html', 'timeline.html', 'how-to-get-the-raw-data.html', 'glossary.html', '404.html']) {
...
// callsign-events.js — whose markup hardcodes hrefs such as ledger.html,
