...
const EXPECTED_CATEGORIES: Record<string, CategoryExpectation> = {
  Full: {
    legacy: { records: 1_423_293, callsigns: 98_747, allocated: 59_508 },
    folded: { records: 1_357_586, callsigns: 94_765, allocated: 59_505 },
    variants: ['Amateur Full Radio Licence', 'Full'],
    reason: AVAILABLE_POOL_CLASS,
  },
  Foundation: {
    legacy: { records: 816_767, callsigns: 47_349, allocated: 37_964 },
    folded: { records: 753_651, callsigns: 45_338, allocated: 37_963 },
    variants: ['Amateur Foundation Radio Licence', 'Foundation'],
    reason: AVAILABLE_POOL_CLASS,
  },
  Intermediate: {
    legacy: { records: 388_992, callsigns: 24_097, allocated: 15_338 },
    folded: { records: 310_029, callsigns: 21_177, allocated: 15_325 },
    variants: ['Amateur Intermediate Radio Licence', 'Intermediate'],
    reason: AVAILABLE_POOL_CLASS,
  },
  Club: {
    legacy: { records: 37_976, callsigns: 2_459, allocated: 2_146 },
    folded: { records: 37_959, callsigns: 2_460, allocated: 2_146 },
    variants: ['Amateur Club Radio Licence'],
    reason: CLEANED_KEY,
  },
  'Temporary Reciprocal': {
    legacy: { records: 1_483, callsigns: 126, allocated: 83 },
    folded: { records: 1_483, callsigns: 122, allocated: 82 },
    variants: ['Amateur Temporary Reciprocal Radio Licence'],
    reason: CLEANED_KEY,
  },
  'Special Event': {
    legacy: { records: 1_338, callsigns: 1_316, allocated: 54 },
    folded: { records: 1_338, callsigns: 1_316, allocated: 54 },
