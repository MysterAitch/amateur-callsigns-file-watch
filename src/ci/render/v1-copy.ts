...
export const V1_COPY = {
  ...
  glossary: {
    ...
    // The record's central convention as a linkable term, its wording carried from
    // the already-reviewed fidelity-page copy rather than re-authored (see
    // site/v1/copy.js for the rationale). Kept string-identical to the browser twin.
    ...
    // it, and each carrying prior reviewed reader wording where it existed. See
    // site/v1/copy.js for the rationale; kept string-identical.
