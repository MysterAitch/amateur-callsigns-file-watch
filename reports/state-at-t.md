...
| `licence-version-original-start` | licence-start | licence-start evidence; earliest SURVIVING start only (#800), pre-1977 unreliability (#565) |
...
| `licence-original-start` | licence-start | licence-start evidence; earliest SURVIVING start only (#800), pre-1977 unreliability (#565) |
