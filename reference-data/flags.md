...
| `class-product-mismatch` | licence class implied by the prefix series disagrees with the `product` column (both known) | the planned prefix-vs-licence-level analysis; empty product = never-licensed, never a mismatch |
